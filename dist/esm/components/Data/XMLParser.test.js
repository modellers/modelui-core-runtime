import { XMLParser, config, events, triggers } from './XMLParser.js';
...
describe('XMLParser register', function () {
  var tests = createComponentRegisterTests(Manager.ComponentManager.getInstance(), registerComponents, 'xml', XMLParser, triggers, events, config, {});
  tests.forEach(function (t) {
    test(t.title, t.test);
  });
});
describe('XMLParser memory test', function () {
  ...
  test('Parsing simple XML', function (done) {
    ...
    testEventSequence(Manager.ComponentManager.getInstance(), 'test_xmlParser', 'read', {
  ...
  test('Parsing to XML using generated JSON', function (done) {
    ...
    testEventSequence(Manager.ComponentManager.getInstance(), 'test_xmlParser', 'convert', {
      json: {
        foo: {
          '#text': 'bar',
          '@_attr': 'value'
