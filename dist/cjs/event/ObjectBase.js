...
var components_Data_MemoryManager = require('../components/Data/MemoryManager.js');
...
var StateObject = /*#__PURE__*/function (_StateLess) {
  _rollupPluginBabelHelpers._inherits(StateObject, _StateLess);
  var _super = _rollupPluginBabelHelpers._createSuper(StateObject);
  /*
    docs = data || {};
  ...
  function StateObject(props) {
    var _this;
    _rollupPluginBabelHelpers._classCallCheck(this, StateObject);
    _this = _super.call(this, props);
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "getData", function () {
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "deepMerge", function (obj_target, obj_source) {
      return util_ObjUtil.mergeDeep(obj_target, obj_source); // { ...obj_target, ...obj_source }
    });
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "raiseSuccessEvent", function (event_name, data, evt) {
      _this.triggerEvent(event_name, data, evt);
    });
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "raiseFailureEvent", function (event_name, data, evt) {
      // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Using_promises
      _this.triggerEvent(event_name, data, evt);
    });
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "isValidDocumentSchema", function (doc, schema) {
      // returns true if doc validates against schema
      return true;
    });
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "isValidDocumentId", function (document_id) {
      return document_id !== null && document_id !== undefined;
    });
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "getValidDocumentId", function (obj) {
            ...
            function update_one(obj, docs, schema) {
              ...
              if (schema_validation) {
                ...
                if (document_id) {
                  ...
                  if (doc) {
                    try {
                      docs[document_id] = util_ObjUtil.mergeDeep(doc || {}, obj);
    ...
    components_Data_MemoryManager.MemoryManager.getInstance().registerMemory(props.id, _rollupPluginBabelHelpers._assertThisInitialized(_this));
    return _this;
  }
  return _rollupPluginBabelHelpers._createClass(StateObject);
