...
function getNodeDataAtTreeIndexOrNextIndex(_ref) {
  ...
  var selfPath = !isPseudoRoot ? [].concat(_rollupPluginBabelHelpers._toConsumableArray(path), [getNodeKey({
    node: node,
  ...
  for (var i = 0; i < childCount; i += 1) {
    var result = getNodeDataAtTreeIndexOrNextIndex({
      ...
      lowerSiblingCounts: [].concat(_rollupPluginBabelHelpers._toConsumableArray(lowerSiblingCounts), [childCount - i - 1]),
      path: selfPath
    });
    if (result.node) {
      return result;
...
function mapDescendants(_ref4) {
  ...
  var nextNode = _rollupPluginBabelHelpers._objectSpread2({}, node);
...
function toggleExpandedForAll(_ref9) {
  ...
  return map({
    ...
    callback: function callback(_ref10) {
      ...
      return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, node), {}, {
        expanded: expanded
      });
    },
    ...
    for (var i = 0; i < node.children.length; i += 1) {
      ...
      if (_result !== RESULT_MISS) {
        if (_result) {
          ...
          return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, node), {}, {
            children: [].concat(_rollupPluginBabelHelpers._toConsumableArray(node.children.slice(0, i)), [_result], _rollupPluginBabelHelpers._toConsumableArray(node.children.slice(i + 1)))
          });
        }
        // If the result was falsy (returned from the newNode function), then
        //  delete the node from the array.
        return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, node), {}, {
          children: [].concat(_rollupPluginBabelHelpers._toConsumableArray(node.children.slice(0, i)), _rollupPluginBabelHelpers._toConsumableArray(node.children.slice(i + 1)))
        });
      }
...
function addNodeUnderParent(_ref19) {
  ...
  if (parentKey === null) {
    return addAsFirstChild ? {
      treeData: [newNode].concat(_rollupPluginBabelHelpers._toConsumableArray(treeData || [])),
      treeIndex: 0
    } : {
      treeData: [].concat(_rollupPluginBabelHelpers._toConsumableArray(treeData || []), [newNode]),
  ...
  var changedTreeData = map({
    ...
    callback: function callback(_ref20) {
      ...
      hasBeenAdded = true;
      var parentNode = _rollupPluginBabelHelpers._objectSpread2({}, node);
      if (expandParent) {
      ...
      if (!parentNode.children) {
        ...
        return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, parentNode), {}, {
          children: [newNode]
        });
      }
      ...
      var children = addAsFirstChild ? [newNode].concat(_rollupPluginBabelHelpers._toConsumableArray(parentNode.children)) : [].concat(_rollupPluginBabelHelpers._toConsumableArray(parentNode.children), [newNode]);
      return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, parentNode), {}, {
        children: children
      });
    }
...
function addNodeAtDepthAndIndex(_ref21) {
  ...
  var selfPath = function selfPath(n) {
    return isPseudoRoot ? [] : [].concat(_rollupPluginBabelHelpers._toConsumableArray(path), [getNodeKey({
      node: n,
      treeIndex: currentIndex
    })]);
  };
  ...
  if (currentIndex >= minimumTreeIndex - 1 || isLastChild && !(node.children && node.children.length)) {
    if (typeof node.children === 'function') {
      ...
      var _nextNode = _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, node), extraNodeProps), {}, {
        children: node.children ? [newNode].concat(_rollupPluginBabelHelpers._toConsumableArray(node.children)) : [newNode]
      });
      return {
        node: _nextNode,
  ...
  if (currentDepth >= targetDepth - 1) {
    ...
    var _nextNode2 = _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, node), {}, {
      children: [].concat(_rollupPluginBabelHelpers._toConsumableArray(node.children.slice(0, insertIndex)), [newNode], _rollupPluginBabelHelpers._toConsumableArray(node.children.slice(insertIndex)))
    });
  ...
  var nextNode = _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, node), {}, {
  ...
  if (insertedTreeIndex !== null) {
    ...
    result.parentPath = [].concat(_rollupPluginBabelHelpers._toConsumableArray(selfPath(nextNode)), _rollupPluginBabelHelpers._toConsumableArray(pathFragment));
...
function insertNode(_ref22) {
  ...
  return {
    ...
    treeIndex: treeIndex,
    path: [].concat(_rollupPluginBabelHelpers._toConsumableArray(insertResult.parentPath), [getNodeKey({
      node: newNode,
      treeIndex: treeIndex
    })]),
...
function getTreeFromFlatData(_ref24) {
  ...
  var trav = function trav(parent) {
    ...
    if (parentKey in childrenToParents) {
      return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, parent), {}, {
        children: childrenToParents[parentKey].map(function (child) {
          return trav(child);
        })
      });
    }
    return _rollupPluginBabelHelpers._objectSpread2({}, parent);
  };
...
function find(_ref25) {
  ...
  var trav = function trav(_ref26) {
    ...
    if (!isPseudoRoot && searchMethod(_rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, extraInfo), {}, {
      node: node,
    ...
    var childIndex = currentIndex;
    var newNode = _rollupPluginBabelHelpers._objectSpread2({}, node);
    if (hasChildren) {
      // Get all descendants
      newNode.children = newNode.children.map(function (child) {
        ...
        if (mapResult.matches.length > 0 || mapResult.hasFocusMatch) {
          matches = [].concat(_rollupPluginBabelHelpers._toConsumableArray(matches), _rollupPluginBabelHelpers._toConsumableArray(mapResult.matches));
    ...
    if (!isPseudoRoot && !newNode.expanded) {
      matches = matches.map(function (match) {
        return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, match), {}, {
          treeIndex: null
        });
      });
    }
    ...
    if (isSelfMatch) {
      matches = [_rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, extraInfo), {}, {
        node: newNode
      })].concat(_rollupPluginBabelHelpers._toConsumableArray(matches));
    }
    return {
