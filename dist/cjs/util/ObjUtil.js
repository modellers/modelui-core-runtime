...
var _loadash = lodash.exports;

var isObject = function isObject(obj) {
  if (_rollupPluginBabelHelpers._typeof(obj) === 'object') {
...
var getObjectAsArray = function getObjectAsArray(obj) {
  if (isObject(obj)) {
    return [obj];
  }
  return obj;
  ...
  if (isObject(target) && isObject(source)) {
    for (var key in source) {
      if (isObject(source[key])) {
        if (!target[key]) Object.assign(target, _rollupPluginBabelHelpers._defineProperty({}, key, {}));
        mergeDeep(target[key], source[key]);
      } else {
        Object.assign(target, _rollupPluginBabelHelpers._defineProperty({}, key, source[key]));
      }
    }
  }
...
exports.getObjectAsArray = getObjectAsArray;
exports.isObject = isObject;
exports.md5 = md5;
exports.mergeDeep = mergeDeep;
exports.removeItemIndexByIndex = removeItemIndexByIndex;
