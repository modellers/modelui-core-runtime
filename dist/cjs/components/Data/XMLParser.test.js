...
describe('XMLParser protocol', function () {
  var tests = util_TestUtil.createComponentClassTests(layout_Manager["default"].ComponentManager.getInstance(), components_Components, null, components_Data_XMLParser.config, ['read', 'convert'], ['reading', 'read', 'failure_reading', 'converting', 'converted', 'failure_converting'], {}, undefined, {
    render: false
  });
...
describe('XMLParser register', function () {
  var tests = util_TestUtil.createComponentRegisterTests(layout_Manager["default"].ComponentManager.getInstance(), components_Components, 'xml', components_Data_XMLParser.XMLParser, components_Data_XMLParser.triggers, components_Data_XMLParser.events, components_Data_XMLParser.config, {});
  tests.forEach(function (t) {
    test(t.title, t.test);
  });
});
describe('XMLParser memory test', function () {
  beforeEach(function () {
    event_Event.EventManager.getInstance().clearAll();
  });
  test('Parsing simple XML', function (done) {
    new components_Data_XMLParser.XMLParser({
      id: 'test_xmlParser',
      schema: {},
      data: {},
      type: 'xml',
    ...
    util_TestUtil.testEventSequence(layout_Manager["default"].ComponentManager.getInstance(), 'test_xmlParser', 'read', {
  ...
  test('Parsing to XML using generated JSON', function (done) {
    new components_Data_XMLParser.XMLParser({
      id: 'test_xmlParser',
      schema: {},
      data: {},
    ...
    util_TestUtil.testEventSequence(layout_Manager["default"].ComponentManager.getInstance(), 'test_xmlParser', 'convert', {
      json: {
        foo: {
          '#text': 'bar',
          '@_attr': 'value'
  ...
  test('Parsing simple CMMN', function (done) {
    new components_Data_XMLParser.XMLParser({
      id: 'test_xmlParser',
      schema: {},
      data: {},
...
exports.test_data_cmmn_json = test_data_cmmn_json;
