...
export const triggers = {
  ...
  select: {
    info: { name: 'Select', description: 'Selects item by id' },
    schema: {},
    alias: []
  },
  clear: {
...
export class StateOMG extends StateInstance {
  ...
  registerComponent = (actionHandlers, eventHandlers, component_info) => {
    ...
    // register componenet overiding or adding new event handlers
    this.ddEvent = EventManager.getInstance().register(
      this.props.id,
...
export class OMGBase extends StateBaseComponent.StateBaseComponent {
  /**
